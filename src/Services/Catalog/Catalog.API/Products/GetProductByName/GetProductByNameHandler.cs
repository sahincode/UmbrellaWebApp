...
namespace Catalog.API.Products.GetProductByName
{
    ...
    public class GetProductByNameHandler(IDocumentSession session, ILogger<GetProductByNameHandler> logger) : IQueryHandler<GetProductByNameQuery, GetProductByNameResult>
    {
